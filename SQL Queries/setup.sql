...
create table staff(staff_number varchar(100) UNIQUE,
...
create table client_registration(client_no varchar(100) UNIQUE,
name varchar(100),
type varchar(100),
max_rent int,
...
create table prop_registration(p_no varchar(100) UNIQUE,
type varchar(100),
rooms int,
rent int,
...
branch_address varchar(100) UNIQUE,
telephone_number varchar(100),
city varchar(100));
