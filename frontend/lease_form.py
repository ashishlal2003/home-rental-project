...
full_name_label=Label(root, text="Full Name (please print)").place(x=50, y=90)
...
submit_but=Button(root, text="Submit", width=10, bg="purple", fg="white", command=func).place(x=50, y=540)
